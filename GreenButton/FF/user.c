...
{	
	U32 StartTicks = 0;
	U8 index,index1,error,ErrCnt,counter,cnt;
	bit IGN_OFF=1;
...
**************************************************************************/
	txframe.MsgNum = 20;			    						
	txframe.arbID = 0x1E114000;		   	
	txframe.sz = 0;				  
	tx_can_frame(0);


/*	// build repetative message 6E2 on CAN1
	OneTime[0].cdat[0] = 0xC0;
	OneTime[0].cdat[1] = 0x00;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0x00;
	OneTime[0].cdat[3] = 0x0F;
	OneTime[0].cdat[4] = 0x0F;
	OneTime[0].cdat[5] = 0x00;
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
//U8 AddMessage(U8 port,U32 ID,U16 Rate,U8 cnt,U8 dat[8])
	AddMessage(0,0x6314018,50,8,OneTime[0].cdat);

	// build repetative message 3D3 on CAN0 (vin)
	OneTime[0].cdat[0] = 0;
	OneTime[0].cdat[1] = 0;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0;
	OneTime[0].cdat[3] = 0xF0;
	AddMessage(0,0x4394000,50,4,OneTime[0].cdat);*/

	// build repetative message 190 on CAN0 (IGN)
	OneTime[0].cdat[0] = 0x20;
	OneTime[0].cdat[1] = 0x04;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0x48;
	OneTime[0].cdat[3] = 0x00;
	OneTime[0].cdat[4] = 0x00;
	OneTime[0].cdat[5] = 0x00;
	OneTime[0].cdat[6] = 0x0F;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x6214000,250,8,OneTime[0].cdat);

	// build repetative message 190 on CAN0 (IGN)
	OneTime[0].cdat[0] = 0x00;
	OneTime[0].cdat[1] = 0x1E;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0x05;
	OneTime[0].cdat[3] = 0x40;
	OneTime[0].cdat[4] = 0x8C;
	OneTime[0].cdat[5] = 0x4F;
	AddMessage(0,0xE094000,1000,6,OneTime[0].cdat);
	...
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x6314000,250,8,OneTime[0].cdat);
...
/*	// build repetative message 49D on CAN0 (lang)
	...
	OneTime[0].cdat[4] = 0x00;
	OneTime[0].cdat[5] = 0x00;
	OneTime[0].cdat[6] = 0x00;	// defaulted to english?i
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x4214006,50,8,OneTime[0].cdat);*/

	// build repetative message 6EA on CAN0
	OneTime[0].cdat[0] = 0x79;
	OneTime[0].cdat[1] = 0x50;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0x00;
	OneTime[0].cdat[3] = 0x02;
	OneTime[0].cdat[4] = 0x3E;
	OneTime[0].cdat[5] = 0xFE;
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x63D4000,500,8,OneTime[0].cdat);
	...
	OneTime[0].cdat[2] = 0x00;
	OneTime[0].cdat[3] = 0x00;
	OneTime[0].cdat[4] = 0xF0;
	OneTime[0].cdat[5] = 0x00;
	OneTime[0].cdat[6] = 0x60;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x4394100,100,8,OneTime[0].cdat);
	...
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x6284000,500,8,OneTime[0].cdat);
	...
	OneTime[0].cdat[2] = 0x00;
	OneTime[0].cdat[3] = 0xF0;
	AddMessage(0,0x4394000,100,4,OneTime[0].cdat);

/*	// build repetative message 6EA on CAN0
	OneTime[0].cdat[0] = 0x00;
	OneTime[0].cdat[1] = 0x83;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0x80;
	OneTime[0].cdat[3] = 0x84;
	OneTime[0].cdat[4] = 0x00;
	OneTime[0].cdat[5] = 0x00;
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x4214001,50,8,OneTime[0].cdat);*/
	
	// build repetative message 6EA on CAN0
	OneTime[0].cdat[0] = 0x03;
	OneTime[0].cdat[1] = 0xCB;	// using OneTime structure as temp storage
	AddMessage(0,0xC3D4000,1000,2,OneTime[0].cdat);

/*	// build repetative message 6EA on CAN0
	OneTime[0].cdat[0] = 0x00;
	AddMessage(0,0x1E114000,50,1,OneTime[0].cdat);

	// build repetative message 6EA on CAN0
	OneTime[0].cdat[0] = 0x17;
	OneTime[0].cdat[1] = 0x60;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0x0D;
	OneTime[0].cdat[3] = 0x04;
	OneTime[0].cdat[4] = 0x25;
	OneTime[0].cdat[5] = 0x00;
	OneTime[0].cdat[6] = 0x24;
	OneTime[0].cdat[7] = 0x20;
	AddMessage(0,0xC114003,50,8,OneTime[0].cdat);

	// build repetative message 6EA on CAN0
	OneTime[0].cdat[0] = 0x27;
	OneTime[0].cdat[1] = 0x00;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0x19;
	OneTime[0].cdat[3] = 0x76;
	OneTime[0].cdat[4] = 0x42;
	OneTime[0].cdat[5] = 0x04;
	OneTime[0].cdat[6] = 0xDC;
	OneTime[0].cdat[7] = 0xD0;
	AddMessage(0,0xC194003,50,8,OneTime[0].cdat);

	// build repetative message 6EA on CAN0
	OneTime[0].cdat[0] = 0xA2;
	OneTime[0].cdat[1] = 0x80;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0x60;
	OneTime[0].cdat[3] = 0x00;
	OneTime[0].cdat[4] = 0x82;
	OneTime[0].cdat[5] = 0x88;
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x6314003,50,8,OneTime[0].cdat);

	// build repetative message 6EA on CAN0
	OneTime[0].cdat[0] = 0x00;
	OneTime[0].cdat[1] = 0x00;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0x22;
	OneTime[0].cdat[3] = 0x5E;
	OneTime[0].cdat[4] = 0x88;
	OneTime[0].cdat[5] = 0x00;
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0xC014003,50,8,OneTime[0].cdat);

	// build repetative message 6EA on CAN0
	OneTime[0].cdat[0] = 0xD3;
	OneTime[0].cdat[1] = 0x03;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0x00;
	OneTime[0].cdat[3] = 0xC0;
	OneTime[0].cdat[4] = 0x08;
	OneTime[0].cdat[5] = 0x01;
	OneTime[0].cdat[6] = 0x60;
	OneTime[0].cdat[7] = 0x02;
	AddMessage(0,0xC394003,50,8,OneTime[0].cdat);

	// build repetative message 6EA on CAN0
	OneTime[0].cdat[0] = 0x09;
	OneTime[0].cdat[1] = 0x25;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0x05;
	OneTime[0].cdat[3] = 0x08;
	OneTime[0].cdat[4] = 0x20;
	OneTime[0].cdat[5] = 0x15;
	OneTime[0].cdat[6] = 0x40;
	AddMessage(0,0xC214003,50,7,OneTime[0].cdat);
*/
/*************************************************************************
 	Button setup
	example below -
...
// Detect and set Radio Code
	OneTime[0].cdat[0] = 0xFF;	// mask bits (0's don't cares, 1's are matches)
	OneTime[0].cdat[1] = 0xFF;
	OneTime[0].cdat[2] = 0xFF;	
	OneTime[1].cdat[0] = 0x00;	// values (ORed)
	OneTime[1].cdat[1] = 0xBF;
	OneTime[1].cdat[2] = 0x82;		// this byte must match
	index = RxMessageConfig1(0,0xA094005,OneTime[0].cdat,OneTime[1].cdat,3);
	OneTime[0].cdat[0] = 0xFF;	// mask bits (ANDed)
	OneTime[0].cdat[1] = 0xFF;
	OneTime[0].cdat[2] = 0xFF;	
	OneTime[1].cdat[0] = 0x00;		// values (ORed)
	OneTime[1].cdat[1] = 0x63;
	OneTime[1].cdat[2] = 0xC1;
	RxMessageConfig2(index,0,0xA114000,OneTime[0].cdat,OneTime[1].cdat,3,0);
...
//U8 AddMessage(U8 port,U32 ID,U16 Rate,U8 cnt,U8 dat[8])
	AddMessage(1,0x6E2,500,8,OneTime[0].cdat);
	...
	OneTime[0].cdat[6] = 0;
	OneTime[0].cdat[7] = 0;
	AddMessage(0,0x3D3,1000,8,OneTime[0].cdat);

	// build repetative message 190 on CAN0 (IGN)
	OneTime[0].cdat[0] = 0;
	OneTime[0].cdat[1] = 0x21;	// using OneTime structure as temp storage
	OneTime[0].cdat[2] = 0;
	OneTime[0].cdat[3] = 0;
	OneTime[0].cdat[4] = 0;
	AddMessage(0,0x190,100,5,OneTime[0].cdat);
	...
	OneTime[0].cdat[6] = 0;
	OneTime[0].cdat[7] = 0;
	AddMessage(0,0x098,100,8,OneTime[0].cdat);
