...
/*	OneTime[0].cdat[0] = 0;
	...
	OneTime[0].cdat[6] = 0;
	OneTime[0].cdat[7] = 0;
	AddMessage(0,0x317,1000,8,OneTime[0].cdat);  // TGW_MSG */
	...
	OneTime[0].cdat[6] = 0xFF;
	OneTime[0].cdat[7] = 0;
	AddMessage(0,0x3B2,1000,8,OneTime[0].cdat);  // CBC_I1
	...
	OneTime[0].cdat[0] = 0x7D;
	OneTime[0].cdat[1] = 0x80;	
	OneTime[0].cdat[2] = 0;
	OneTime[0].cdat[3] = 0x0A;
	OneTime[0].cdat[4] = 0;
	OneTime[0].cdat[5] = 0x90;
	OneTime[0].cdat[6] = 0;
	OneTime[0].cdat[7] = 0;
	...
	OneTime[0].cdat[7] = 0x01;
	AddMessage(0,0x3DE,1000,8,OneTime[0].cdat);  // CBC_CFG1
	...
	OneTime[0].cdat[6] = 0;
	OneTime[0].cdat[7] = 0;
	AddMessage(0,0x3E0,500,8,OneTime[0].cdat);  // VIN
...
//U8 SimpleButtonConfig(U8 button,U8 port,U32 ID,U8 mask[8],U8 value[8],count);
	...
	OneTime[0].cdat[7] = 0xFF;
	OneTime[1].cdat[0] = 0;		// values (ORed)
//	OneTime[1].cdat[1] = Day_Night_mode;
...
// Radio Off
	...
	OneTime[1].cdat[0] = 0x02;		// values (ORed)
//U8 SimpleButtonConfig(U8 button,U8 port,U32 ID,U8 mask[8],U8 value[8],count);
	SimpleButtonConfig(10,0,0x12B,OneTime[0].cdat,OneTime[1].cdat,0);

// Radio On
	OneTime[0].cdat[0] = 0;	// mask bits (ANDed)
	OneTime[1].cdat[0] = 0x03;  // values (ORed)
//U8 SimpleButtonConfig(U8 button,U8 port,U32 ID,U8 mask[8],U8 value[8],count);
	SimpleButtonConfig(0,0,0x12B,OneTime[0].cdat,OneTime[1].cdat,0);
			...
			if (index1 < TXBUFFS)				// empty one time available
			{
				...
				switch(keys & 0xF0)
				{
					...
					case 0x30:	// IGN_START
						...
						OneTime[index1].cdat[2] = 0x0;
						OneTime[index1].cdat[3] = 0x0;
						AlterMessageByte(0,0x322,0,OneTime[index1].cdat,4,0);
						IGN_OFF_FLG = 1;
						break;
					case 0x40:	// IGN_RUN_0
						// ID 190, alter byte 0,1 
					...
					case 0x70:
						...
						OneTime[index1].cdat[2] = 0x0;
						OneTime[index1].cdat[3] = 0x0;
						OneTime[index1].cdat[4] = 0x2C; 			// Reverse			
						OneTime[index1].cdat[5] = 0x0;
						OneTime[index1].cdat[6] = 0x07;
						OneTime[index1].cdat[7] = 0xD0;
						AlterMessageByte(0,0x322,0,OneTime[index1].cdat,8,0);
