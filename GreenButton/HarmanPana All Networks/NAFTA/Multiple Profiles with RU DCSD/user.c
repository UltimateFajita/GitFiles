...
void User1()	// program select 1, PNET
{	
...
**************************************************************************/
	...
	OneTime[0].cdat[1] = 0;	
	OneTime[0].cdat[2] = 0;
	OneTime[0].cdat[3] = 0x80;
	OneTime[0].cdat[4] = 0;
	OneTime[0].cdat[5] = 0;
	AddMessage(0,0x1C0,200,6,OneTime[0].cdat);  // RFHUB_A2
	...
	OneTime[0].cdat[0] = 0x18;
	OneTime[0].cdat[1] = 0x38;	
	OneTime[0].cdat[2] = 0x7D;
	OneTime[0].cdat[3] = 0;
	AddMessage(0,0x2C2,200,4,OneTime[0].cdat);  // CBC_I3
	
	OneTime[0].cdat[0] = 0x01;
	OneTime[0].cdat[1] = 0x34;	
	OneTime[0].cdat[2] = 0x01;
	OneTime[0].cdat[3] = 0x3D;
	OneTime[0].cdat[4] = 0x00;
	...
	OneTime[0].cdat[0] = 0xA5;
	OneTime[0].cdat[1] = 0x0E;	
	OneTime[0].cdat[2] = 0x1F;
	OneTime[0].cdat[3] = 0x60;
	OneTime[0].cdat[4] = 0x01;
	OneTime[0].cdat[5] = 0x80;
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x381,2000,8,OneTime[0].cdat);  // VehCfg7
	...
	OneTime[0].cdat[0] = 0x41;
	OneTime[0].cdat[1] = 0x00;	
	OneTime[0].cdat[2] = 0x7E;
	OneTime[0].cdat[3] = 0x00;
	OneTime[0].cdat[4] = 0x00;
	OneTime[0].cdat[5] = 0xFF;
	OneTime[0].cdat[6] = 0xFF;
	OneTime[0].cdat[7] = 0x3F;
	AddMessage(0,0x3B2,500,8,OneTime[0].cdat);  // CBC_I1
	
	OneTime[0].cdat[0] = 0x75;
	OneTime[0].cdat[1] = 0x36;	
	OneTime[0].cdat[2] = 0x02;
	OneTime[0].cdat[3] = 0xC1;
	OneTime[0].cdat[4] = 0x61;
	OneTime[0].cdat[5] = 0xB7;
	OneTime[0].cdat[6] = 0xDF;
	OneTime[0].cdat[7] = 0x54;
	AddMessage(0,0x3B3,2000,8,OneTime[0].cdat);  // VehCfgCSM1
	
	OneTime[0].cdat[0] = 0x79;
	OneTime[0].cdat[1] = 0x80;	
	OneTime[0].cdat[2] = 0xFC;
	OneTime[0].cdat[3] = 0x9F;
	OneTime[0].cdat[4] = 0x00;
	OneTime[0].cdat[5] = 0x81;
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x3B4,2000,8,OneTime[0].cdat);  // VehCfgCSM2
	
	OneTime[0].cdat[0] = 0xBE;
	OneTime[0].cdat[1] = 0x1E;	
	OneTime[0].cdat[2] = 0x00;
	OneTime[0].cdat[3] = 0x00;
	OneTime[0].cdat[4] = 0x00;
	OneTime[0].cdat[5] = 0x19;
	OneTime[0].cdat[6] = 0xD1;
	...
	OneTime[0].cdat[0] = 0xFD;
	OneTime[0].cdat[1] = 0xDF;	
	OneTime[0].cdat[2] = 0x11;
	OneTime[0].cdat[3] = 0x8B;
	OneTime[0].cdat[4] = 0x3D;
	OneTime[0].cdat[5] = 0x00;
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x3E3,2000,8,OneTime[0].cdat);  // NET_CFG_INT
	
	OneTime[0].cdat[0] = 0x81;
	OneTime[0].cdat[1] = 0xDE;	
	OneTime[0].cdat[2] = 0x99;
	OneTime[0].cdat[3] = 0xC2;
	OneTime[0].cdat[4] = 0x04;
	OneTime[0].cdat[5] = 0x00;
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x3E4,2000,8,OneTime[0].cdat);  //NET_CFG_PT
	
	OneTime[0].cdat[0] = 0x49;
	OneTime[0].cdat[1] = 0x2D;	
	OneTime[0].cdat[2] = 0xA2;
	OneTime[0].cdat[3] = 0x48;
	OneTime[0].cdat[4] = 0x00;
	OneTime[0].cdat[5] = 0x07;
	OneTime[0].cdat[6] = 0x72;
	OneTime[0].cdat[7] = 0x0D;
	AddMessage(0,0x3E8,2000,8,OneTime[0].cdat);  // VehCfg1
	...
	OneTime[0].cdat[2] = 0x00;
	OneTime[0].cdat[3] = 0x00;
	OneTime[0].cdat[4] = 0x24;
	OneTime[0].cdat[5] = 0x24;
	OneTime[0].cdat[6] = 0x00;
	OneTime[0].cdat[7] = 0x00;
	AddMessage(0,0x3E9,2000,8,OneTime[0].cdat);  // VehCfg2
	
	OneTime[0].cdat[0] = 0x71;
	OneTime[0].cdat[1] = 0x70;	
	OneTime[0].cdat[2] = 0x24;
	OneTime[0].cdat[3] = 0x0A;
	OneTime[0].cdat[4] = 0x82;
	OneTime[0].cdat[5] = 0x15;
	OneTime[0].cdat[6] = 0xAB;
	OneTime[0].cdat[7] = 0xE5;
	AddMessage(0,0x3EA,2000,8,OneTime[0].cdat);  // VehCfg3
	
	OneTime[0].cdat[0] = 0x43;
	OneTime[0].cdat[1] = 0xE8;	
	OneTime[0].cdat[2] = 0x0C;
	OneTime[0].cdat[3] = 0xB3;
	OneTime[0].cdat[4] = 0x00;
	OneTime[0].cdat[5] = 0x00;
	OneTime[0].cdat[6] = 0x09;
	OneTime[0].cdat[7] = 0x24;
	AddMessage(0,0x3EB,2000,8,OneTime[0].cdat);  // VehCfg4
	
	OneTime[0].cdat[0] = 0xE9;
	OneTime[0].cdat[1] = 0x04;	
	OneTime[0].cdat[2] = 0x35;
//	OneTime[0].cdat[3] = 0x20;
	OneTime[0].cdat[3] = 0x01;
