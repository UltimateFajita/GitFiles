typedef struct tCANmesg 
{
    U32  ID;                                                    // can id 
 	U8   ExtFlg;                                                // identifier xxxID 29 or 11
    U8   Dlc;                                                   // data length:
    U8   Dta[8];                            					// data
    U8   Rtr;                                                   // rtr 
//    U8   filhit;
...
void CAN1read_id( const U8 mcp_addr, U32* id );
void CAN1initCANBuffers(void);
U8 CAN1init(const U8 canSpeed);
void CAN1write_canMsg( U8 buffer_sidh_addr);
U8 CAN1read_canMsg( U8 buffer_sidh_addr);
...
#define RX0_FILTER0	0
#define RX0_FILTER1	1
#define RX1_FILTER2	2
#define RX1_FILTER3	3
#define RX1_FILTER4	4
#define RX1_FILTER5	5
#define RX0_MASK	6
#define RX1_MASK	7
