...
**************************************************************************/
	...
	OneTime[0].cdat[3] = 0;
	OneTime[0].cdat[4] = 0;
	OneTime[0].cdat[5] = 0x48;
	OneTime[0].cdat[6] = 0;
	OneTime[0].cdat[7] = 0;
	AddMessage(0,0x332,100,8,OneTime[0].cdat);  // GW_C_I
...
//U8 SimpleButtonConfig(U8 button,U8 port,U32 ID,U8 mask[8],U8 value[8],count);
	...
	*/
	...
	OneTime[1].cdat[7] = 0;
//U8 SimpleButtonConfig(U8 button,U8 port,U32 ID,U8 mask[8],U8 value[8],count);
	SimpleButtonConfig(11,0,0x332,OneTime[0].cdat,OneTime[1].cdat,0);
	...
	OneTime[1].cdat[7] = 0;
//U8 SimpleButtonConfig(U8 button,U8 port,U32 ID,U8 mask[8],U8 value[8],count);
	SimpleButtonConfig(1,0,0x332,OneTime[0].cdat,OneTime[1].cdat,0);
/*
	// Door Ajar
	OneTime[0].cdat[0] = 0xFF;	// mask bits (ANDed)
	OneTime[0].cdat[1] = 0xFF;
...
// Detect and set for English
	...
	RxMessageConfig2(index,0,0x322,OneTime[0].cdat,OneTime[1].cdat,8,0);
