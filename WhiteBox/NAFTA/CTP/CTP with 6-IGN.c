...
{	
			...
			onehundredms();						
			txframe.arbID = 0x3f2;		  	//Message ID EcuCfg3 									
			txframe.sz = 8;				  	//8 bytes
			txframe.cdat[0] = 0x15;	      	// EC_ECUCfg3_Stat and EC_AudTel1A				
			txframe.cdat[1] = 0x02;	
			txframe.cdat[2] = 0x57;	      					
			txframe.cdat[3] = 0xA0;	  
			txframe.cdat[4] = 0x09;	      						
			...
			txframe.sz = 8;				  	//8 bytes
			txframe.cdat[0] = 0x00;	      	// 			
			txframe.cdat[1] = 0x01;			//Day_lgt_MD
			txframe.cdat[2] = 0x00;	      					
			txframe.cdat[3] = 0x00;	  
			txframe.cdat[4] = 0x09;	      						
			txframe.cdat[5] = 0x00;	
			...
			onehundredms();		 														
			txframe.arbID = 0x3E0;			// VIN message low									
			txframe.sz = 8;
			txframe.cdat[0] = 0x00;									
			txframe.cdat[1] = 0x31;
			txframe.cdat[2] = 0x43;									
			...
			onehundredms();		 														
			txframe.arbID = 0x3E0;			// VIN message mid										
			txframe.sz = 8;
			txframe.cdat[0] = 0x01;									
			txframe.cdat[1] = 0x47;
			txframe.cdat[2] = 0x33;									
			...
			onehundredms();			 														
			txframe.arbID = 0x3E0;			// VIN message high										
			txframe.sz = 8;
			txframe.cdat[0] = 0x02;									
			txframe.cdat[1] = 0x31;
			txframe.cdat[2] = 0x31;									
			...
			onehundredms();							
			txframe.arbID = 0x3E2;		  	//Message ID NET_CFG_AT										
			txframe.sz = 3;				  	//3 bytes
			txframe.cdat[0] = 0x21;	      	//Turns on ICS					
			txframe.cdat[1] = 0x08;			//Turns on HFM
			txframe.cdat[2] = 0x00;	      					
			tx_can_frame(0);
