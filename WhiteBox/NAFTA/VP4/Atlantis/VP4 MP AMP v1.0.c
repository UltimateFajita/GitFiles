...
void IGN_MSG (void)
{
	...
	if (IGN_OFF == 0)
	{
			...
			while (iii < 300)
			{
				...
				txframe.arbID = 0x356;		  	//Message ID	CBC_13 Vehicle start packet									
				...
				txframe.cdat[2] = 0x69;	      	//null					
				txframe.cdat[3] = 0x2F;	  		//null  
				txframe.cdat[4] = 0x00;
				txframe.cdat[5] = 0x00;
				txframe.cdat[6] = 0x00;
				txframe.cdat[7] = 0x00;
	...
	*/
	if (IGN_RUN_0 == 0)
	{
			...
			txframe.sz = 8;				  	//Message size(number of bytes 1-8)
			txframe.cdat[0] = 0x00;	      	//ignition run, start not active  04 = run ;02=ACC ;0D= NormalStart, key in Ign, 						
			txframe.cdat[1] = 0x80;		  	//key in ignition
			txframe.cdat[2] = 0x69;	      	//null					
			txframe.cdat[3] = 0x2F;	  		//null  
			txframe.cdat[4] = 0x00;
			txframe.cdat[5] = 0x00;
...
{	
		...
		char VIN[17] = "1C3CCCCB9FN1136UC";
			...
			onehundredms();				  	//100ms delay loop
			txframe.MsgNum = 1;			  	//Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3E2;		  	//Message ID	CBC_13 Vehicle start packet									
			txframe.sz = 8;				  	//Message size(number of bytes 1-8)
			txframe.cdat[0] = 0x00;	      	//ignition run, start not active  04 = run ;02=ACC ;0D= NormalStart, key in Ign, 						
			txframe.cdat[1] = 0x00;		  	//key in ignition
			txframe.cdat[2] = 0x00;	      	//null					
			...
			txframe.cdat[5] = 0x00;
			txframe.cdat[6] = 0x00;
			txframe.cdat[7] = 0x020;
			tx_can_frame(0,11);	
			
			onehundredms();				  	//100ms delay loop
			txframe.MsgNum = 1;			  	//Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x2EC;		  	//Message ID	CBC_13 Vehicle start packet									
			txframe.sz = 8;				  	//Message size(number of bytes 1-8)
			txframe.cdat[0] = 0x00;	      	//ignition run, start not active  04 = run ;02=ACC ;0D= NormalStart, key in Ign, 						
			txframe.cdat[1] = 0x00;		  	//key in ignition
			txframe.cdat[2] = 0x00;	      	//null					
			...
			onehundredms();				  	//100ms delay loop
			txframe.MsgNum = 1;			  	//Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x1E340024;		  	//Message ID	CBC_13 Vehicle start packet									
			txframe.sz = 2;				  	//Message size(number of bytes 1-8)
			txframe.cdat[0] = 0x00;	      	//ignition run, start not active  04 = run ;02=ACC ;0D= NormalStart, key in Ign, 						
			txframe.cdat[1] = 0xCE;		  	//key in ignition
			tx_can_frame(0,29);	

			onehundredms();				  	//100ms delay loop
			txframe.MsgNum = 1;			  	//Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x760;		  	//Message ID	CBC_13 Vehicle start packet									
			txframe.sz = 6;				  	//Message size(number of bytes 1-8)
			txframe.cdat[0] = 0x00;	      	//ignition run, start not active  04 = run ;02=ACC ;0D= NormalStart, key in Ign, 						
			txframe.cdat[1] = 0x00;		  	//key in ignition
			txframe.cdat[2] = 0x03;	      	//null					
			txframe.cdat[3] = 0xE8;	  		//null  
			txframe.cdat[4] = 0x00;
			txframe.cdat[5] = 0x00;
				...
				if (PH_BUTTON == 0 )                   
      				...
      				{ 
				...
				else
						{
							...
							txframe.arbID= 0x2EE;		//default state									
							txframe.sz = 8;				
							txframe.cdat[0] = 0x00;	      						
							txframe.cdat[1] = 0x00;	
							txframe.cdat[2] = 0x00;	      					
