...
{	
		...
		if(INGITION_SW == 0)
			...
			txframe.arbID = 0x2AD;		  //Message ID CBC_12  									
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x00;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x07;	      					
			...
			shortdelay();
			txframe.MsgNum = 2;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x2C2;		  //Message ID CBC_12  									
			...
			shortdelay();
			txframe.MsgNum = 2;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x2C5;		  //Message ID CBC_12  									
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x00;	      						
			txframe.cdat[1] = 0xEE;	
			txframe.cdat[2] = 0xEE;	      					
			...
			shortdelay();
			txframe.MsgNum = 2;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x305;		  //Message ID CBC_12  									
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x00;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	      					
			...
			shortdelay();
			txframe.MsgNum = 2;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3A2;		  //Message ID CBC_12  									
			...
			shortdelay();
			txframe.MsgNum = 2;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3B2;		  //Message ID CBC_12  									
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x01;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x80;	      					
			...
			shortdelay();
			txframe.MsgNum = 2;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3DE;		  //Message ID CBC_12  									
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x3E;	      						
			txframe.cdat[1] = 0x1E;	
			txframe.cdat[2] = 0x1E;	      					
			...
			txframe.cdat[5] = 0x01;	
			txframe.cdat[6] = 0x91;
			txframe.cdat[7] = 0x01;	      // Change to 0x02 for USB and AUX, 0x03 for USB/SD/AUX	  
			tx_can_frame(0);
			...
			txframe.cdat[5] = 0x00;	
			txframe.cdat[6] = 0x01;
			txframe.cdat[7] = 0x90;	      // Change to 0x02 for USB and AUX, 0x03 for USB/SD/AUX	  
			tx_can_frame(0);
			...
			txframe.cdat[5] = 0x00;	
			txframe.cdat[6] = 0x00;
			txframe.cdat[7] = 0x03;	      // Change to 0x02 for USB and AUX, 0x03 for USB/SD/AUX	  
			tx_can_frame(0);
			...
			tx_can_frame(0);
				...
				if (PH_BUTTON == 0 )                   
      				...
      				{ 
							...
							txframe.arbID = 0x22D;		  //Message ID VR active message byte 5 x02										
							txframe.sz = 8;				  //8 bytes
							txframe.cdat[0] = 0x00;	      						
							txframe.cdat[1] = 0x00;	
			...
			{		
					...
					txframe.arbID = 0x122;		  	//Message ID	CBC_13 Vehicle start packet									
					txframe.sz = 4;				  	//Message size(number of bytes 1-8)
					txframe.cdat[0] = 0x00;	      	//ignition run, start not active						
					txframe.cdat[1] = 0x02;		  	//key in ignition
					txframe.cdat[2] = 0x00;	      	//null					
					txframe.cdat[3] = 0x00;	  		//null  
					tx_can_frame(0);			  	//transmits can frame
