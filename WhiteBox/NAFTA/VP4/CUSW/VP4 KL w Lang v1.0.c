...
/*
sbit SW_VOL_UP  	= P0^7;				// sw1 = 0 means switch pressed
sbit SW_VOL_DWN		= P0^5;				// sw2 = 0 means switch pressed
sbit SW_MODE	  	= P0^6;				// sw3 = 0 means switch pressed
sbit SW_PRESET  	= P0^4;				// sw1 = 0 means switch pressed
sbit SW_CH_UP		= P1^1;				// sw2 = 0 means switch pressed
sbit SW_CH_DWN  	= P1^0;				// sw3 = 0 means switch pressed
*/
...
{	
		...
		char VIN[17] = "1C4PJMBB0EW3001UC";
			...
			shortdelay();
			txframe.MsgNum = 6;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x49D;		  //Message ID VIN, VIN_HI hex 31 = ascii 1										
			txframe.sz = 8;
			...
			*/
			...
			shortdelay();
			txframe.MsgNum = 6;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x08A;		  //Message ID VIN, VIN_HI hex 31 = ascii 1										
			txframe.sz = 3;
			txframe.cdat[0] = 0x00;				  //8 bytes
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	      					  
