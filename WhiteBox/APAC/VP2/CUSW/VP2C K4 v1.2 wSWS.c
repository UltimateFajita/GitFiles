...
{	
		...
		int CAN_BIT_LENGTH = 11;

		char VIN[17] = "1C4PJLAB5GW2015UC";
			...
			shortdelay();
				txframe.arbID= 0x3D3;		//VIN Message							
				txframe.sz = 8;	
				txframe.cdat[0] = 0x00;	  			
				...
				shortdelay();						
				txframe.arbID= 0x3D1;		//default state									
				txframe.sz = 4;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x00;	      					
				...
				txframe.arbID= 0x3CF;		//default state									
				txframe.sz = 4;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x3CB;		//default state									
				txframe.sz = 8;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x772;		//default state									
				txframe.sz = 4;				
				txframe.cdat[0] = 0x60;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x499;		//default state									
				txframe.sz = 5;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x75A;		//default state									
				txframe.sz = 2;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	  
				tx_can_frame(0, CAN_BIT_LENGTH);
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x339;		//default state									
				txframe.sz = 8;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x08;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x5CC;		//default state									
				txframe.sz = 4;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x30;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x33B;		//default state									
				txframe.sz = 8;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x493;		//default state									
				txframe.sz = 2;				
				txframe.cdat[0] = 0x1F;	      						
				txframe.cdat[1] = 0xFF;		  
				tx_can_frame(0, CAN_BIT_LENGTH);
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x548;		//default state									
				txframe.sz = 4;				
				txframe.cdat[0] = 0x07;	      						
				txframe.cdat[1] = 0xF8;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x4A1;		//default state									
				txframe.sz = 7;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x5C8;		//default state									
				txframe.sz = 3;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0xFF;	
				txframe.cdat[2] = 0x00;	  
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x760;		//default state									
				txframe.sz = 4;				
				txframe.cdat[0] = 0x80;	      						
				txframe.cdat[1] = 0xFF;	
				txframe.cdat[2] = 0xF0;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x6A8;		//default state									
				txframe.sz = 2;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	  
				tx_can_frame(0, CAN_BIT_LENGTH);
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x5DC;		//default state									
				txframe.sz = 5;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x6A2;		//default state									
				txframe.sz = 1;				
				txframe.cdat[0] = 0x00;		  
				tx_can_frame(0, CAN_BIT_LENGTH);
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x309;		//default state									
				txframe.sz = 5;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x337;		//default state									
				txframe.sz = 6;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x6A4;		//default state									
				txframe.sz = 8;				
				txframe.cdat[0] = 0x7A;	      						
				txframe.cdat[1] = 0x56;	
				txframe.cdat[2] = 0x00;	      					
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x75E;		//default state									
				txframe.sz = 2;				
				txframe.cdat[0] = 0xFF;	      						
				txframe.cdat[1] = 0x00;	  
				tx_can_frame(0, CAN_BIT_LENGTH);
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x6A6;		//default state									
				txframe.sz = 3;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x00;	
				txframe.cdat[2] = 0x00;		  
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0xE094000;		//default state									
				txframe.sz = 6;				
				txframe.cdat[0] = 0x00;	      						
				txframe.cdat[1] = 0x02;	
				txframe.cdat[2] = 0x00;	      					
...
void SWS_buttons(void)	  
{
	if (PH_BUTTON == 0 )                   
				...
				shortdelay();
				txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
				txframe.arbID= 0x4A3;		  //Message ID VR off									
