...
{	
		...
		char VIN[17] = "1C3CCCCB7FN1124UC";
			...
			txframe.cdat[0] = 0x89;	      						
			txframe.cdat[1] = 0xDA;	
			txframe.cdat[2] = 0x98;	 // lever in reverse     					
			txframe.cdat[3] = 0x06;	  
			txframe.cdat[4] = 0x00;	      						
			txframe.cdat[5] = 0x00;	
			txframe.cdat[6] = 0x00;
			...
			txframe.cdat[0] = 0xFD;	      						
			txframe.cdat[1] = 0x0C;	
			txframe.cdat[2] = 0x10;	 // lever in reverse     					
			txframe.cdat[3] = 0x08;	  
			txframe.cdat[4] = 0x00;	      						
			txframe.cdat[5] = 0x00;	
			txframe.cdat[6] = 0x00;
			...
			txframe.cdat[0] = 0x41;	      						
			txframe.cdat[1] = 0x29;	
			txframe.cdat[2] = 0xA2;	 // lever in reverse     					
			txframe.cdat[3] = 0x15;	  
			txframe.cdat[4] = 0x1E;	      						
			txframe.cdat[5] = 0x80;	
			txframe.cdat[6] = 0x00;
			...
			txframe.cdat[0] = 0x01;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x06;	 // lever in reverse     					
			txframe.cdat[3] = 0x9E;	  
			txframe.cdat[4] = 0x20;	      						
			txframe.cdat[5] = 0x20;	
			txframe.cdat[6] = 0x20;
			...
			txframe.cdat[0] = 0x41;	      						
			txframe.cdat[1] = 0x0D;	
			txframe.cdat[2] = 0x22;	 // lever in reverse     					
			txframe.cdat[3] = 0x48;	  
			txframe.cdat[4] = 0x80;	      						
			txframe.cdat[5] = 0x24;	
			txframe.cdat[6] = 0x03;
			...
			txframe.cdat[0] = 0x45;	      						
			txframe.cdat[1] = 0x02;	
			txframe.cdat[2] = 0x1D;	 // lever in reverse     					
			txframe.cdat[3] = 0x20;	  
			txframe.cdat[4] = 0x1D;	      						
			txframe.cdat[5] = 0xA0;	
			txframe.cdat[6] = 0x00;
			...
			txframe.cdat[0] = 0x00;	      						
			txframe.cdat[1] = 0xEE;	
			txframe.cdat[2] = 0xEE;	 // lever in reverse     					
			txframe.cdat[3] = 0x2E;	  
			txframe.cdat[4] = 0x00;	      						
			txframe.cdat[5] = 0x00;	
			txframe.cdat[6] = 0x00;
				...
				if (PH_BUTTON == 0 )                   
      				...
      				{ 
      				  ...
      				  {  
							...
							txframe.cdat[0] = 0x00;	      						
							txframe.cdat[1] = 0x00;	
							txframe.cdat[2] = 0x40;	  // lever in Park    					
							txframe.cdat[3] = 0x00;	  
							txframe.cdat[4] = 0x00;	      						
							txframe.cdat[5] = 0x00;	
							txframe.cdat[6] = 0x00;
      				  ...
      				  {  
							...
							txframe.cdat[0] = 0x00;	      						
							txframe.cdat[1] = 0x00;	
							txframe.cdat[2] = 0x04;	  // lever in Park    					
							txframe.cdat[3] = 0x00;	  
							txframe.cdat[4] = 0x00;	      						
							txframe.cdat[5] = 0x00;	
							txframe.cdat[6] = 0x00;
      				  ...
      				  {  
							...
							txframe.cdat[0] = 0x00;	      						
							txframe.cdat[1] = 0x00;	
							txframe.cdat[2] = 0x10;	  // lever in Park    					
							txframe.cdat[3] = 0x00;	  
							txframe.cdat[4] = 0x00;	      						
							txframe.cdat[5] = 0x00;	
							txframe.cdat[6] = 0x00;
