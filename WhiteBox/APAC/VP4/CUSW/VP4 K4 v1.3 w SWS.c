...
{	
		...
		char VIN[17] = "1C4PJMDB3GW1014UC";
			...
			shortdelay();
			txframe.MsgNum = 6;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x098;		  //Message ID VIN, VIN_HI hex 31 = ascii 1										
			txframe.sz = 8;
			...
			shortdelay();
			txframe.MsgNum = 6;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x09A;		  //Message ID VIN, VIN_HI hex 31 = ascii 1										
			txframe.sz = 8;
			txframe.cdat[0] = 0x00;				  //8 bytes
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	      					
			...
			shortdelay();
			txframe.MsgNum = 6;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x339;		  //Message ID VIN, VIN_HI hex 31 = ascii 1										
			txframe.sz = 8;
			txframe.cdat[0] = 0x00;				  //8 bytes
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	      					
			...
			shortdelay();
			txframe.MsgNum = 6;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x33B;		  //Message ID VIN, VIN_HI hex 31 = ascii 1										
			txframe.sz = 8;
			txframe.cdat[0] = 0x00;				  //8 bytes
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	      					
			...
			shortdelay();
			txframe.MsgNum = 6;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3CB;		  //Message ID VIN, VIN_HI hex 31 = ascii 1										
			txframe.sz = 8;
			txframe.cdat[0] = 0x00;				  //8 bytes
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	      					
			...
			shortdelay();
			txframe.MsgNum = 6;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x5C8;		  //Message ID VIN, VIN_HI hex 31 = ascii 1										
			txframe.sz = 3;
			txframe.cdat[0] = 0x00;				  //8 bytes
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	      					 
			...
			shortdelay();
			txframe.MsgNum = 6;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x5CA;		  //Message ID VIN, VIN_HI hex 31 = ascii 1										
			txframe.sz = 8;
			txframe.cdat[0] = 0x00;				  //8 bytes
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0xFF;	      					
...
void IGN_MSG (void)
{
	...
	*/
	...
	if ((IGN_OFF != 0) && (IGN_ACC != 0) && (IGN_START != 0) && (IGN_RUN_0 != 0) && (IGN_RUN_5 != 0) && (IGN_RUN_10 != 0))

	{
		...
		txframe.sz = 5;				  	//Message size(number of bytes 1-8)
		txframe.cdat[0] = 0x00;	      	//ignition run, start not active  04 = run ;02=ACC ;0D= NormalStart, key in Ign, 						
		txframe.cdat[1] = 0x21;		  	//key in ignition
		txframe.cdat[2] = 0x00;	      	//null					
		txframe.cdat[3] = 0x00;	  		//null  
		txframe.cdat[4] = 0x00;	  		//null  
		tx_can_frame(0,11);
